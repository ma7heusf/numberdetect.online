  ...
  return (function (A) {
    ...
    return (
      ...
      (B.t = function (A, e) {
        ...
        if ((B.r(g), Object.defineProperty(g, 'default', { enumerable: !0, value: A }), 2 & e && 'string' != typeof A))
          for (var o in A)
            B.d(
              g,
              o,
                  ...
                  this.noSleepVideo.addEventListener('loadedmetadata', function () {
                    e.noSleepVideo.duration <= 1
                      ...
                      : e.noSleepVideo.addEventListener('timeupdate', function () {
                          e.noSleepVideo.currentTime > 0.5 && (e.noSleepVideo.currentTime = Math.random());
                        });
                  }));
          }
          return (
              ...
              },
              {
                ...
                value: function () {
                  Q()
                    ...
                    : C()
                    ? this.noSleepTimer &&
                      (console.warn('\n          NoSleep now disabled for older iOS devices.\n        '), window.clearInterval(this.noSleepTimer), (this.noSleepTimer = null))
